...
export const metadata: Metadata = { title: "Mis Cursos — NeuralPath" };
...
export default async function NinoCursosPage() {
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {enrollments.length === 0 ? (
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          {enrollments.map(({ id, course, progressPct, completedAt }) => (
            <div
              key={id}
            ...
            >
              ...
              <div className="p-5">
                ...
                >
                  {progressPct === 0 ? "▶️ Comenzar" : completedAt ? "🔄 Repasar" : "▶️ Continuar"}
                </Link>
              </div>
            </div>
          ))}
